        ...
        <table class="table">
		    ...
		    ?>
		      <tr>
		        ...
		        <td><a class="btn btn-primary btn-sm" href="<?php echo base_url();?>index.php/proyecto/delete_seccion/<?php echo $s->id_seccion;?>" role="button"><span class="glyphicon glyphicon-trash"></span> Eliminar</a></td>
		      </tr>
		     <?php
		 		}
		     ?>
