          ...
          <table class="table table-bordered">
            ...
            <td ><?php echo $e->no_expediente;?></td>
              ...
              <td><?php echo $e->nombre_centro;?></td>
                ...
                <td><a href="<?php echo base_url('index.php/proyecto/valoracion_abogado');?>/<?php echo $e->id_expediente;?>" role="button"><span class="glyphicon glyphicon-eye-open"></span></span></a></td>
              </tr>
              <?php 
              }
              ?>
