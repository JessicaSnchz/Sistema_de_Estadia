          ...
          <table class="table table-bordered">
            ...
            <td ><?php echo $e->no_expediente;?></td>
              ...
              <td><?php echo $e->nombre_centro;?></td>
                ...
                <td><a class="btn btn-primary" href="<?php echo base_url('index.php/proyecto/valoracion_psicologica');?>/<?php echo $e->id_expediente;?>" role="button"><span class="glyphicon glyphicon-home"></span></span> <span  class="glyphicon glyphicon-user"></span></a></td>

                <td><a class="btn btn-success"  href="<?php echo base_url('index.php/proyecto/informe_familiar');?>/<?php echo $e->id_expediente;?>" role="button"><span  class="glyphicon glyphicon-file"></span> <span  class="glyphicon glyphicon-user"></span></a></td>

                <td><a class="btn btn-warning"  href="<?php echo base_url('index.php/proyecto/informe_menor');?>/<?php echo $e->id_expediente;?>" role="button"><span  class="glyphicon glyphicon-file"></span> <span  class="glyphicon glyphicon-eye-open"></span></a></td>
                
                <td><a class="btn btn-info"  href="<?php echo base_url('index.php/proyecto/notas');?>/<?php echo $e->id_expediente;?>" role="button"><span  class="glyphicon glyphicon-list-alt"></span> <span  class="glyphicon glyphicon-ok"></span></a></td>
              </tr>
              <?php 
              }
              ?>
