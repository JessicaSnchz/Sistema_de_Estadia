<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <li><a href="<?php echo base_url();?>index.php/proyecto/panel">Principal</a></li>
    <li><a href="<?php echo base_url();?>index.php/proyecto/panel">Alta de familiares</a></li>
  </ol>
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
     ...
     <?php
        ...
        echo form_open('proyecto/alta_familiar/'.$ingreso['id_ingreso'],$atributos);
        //var_dump($privilegio);
       ?> 

       <label for="Nombres">Nombre<span class="asterisco">*</span> </label>
      <input type="text" class="form-control" name="expediente" value="<?php if(set_value('nombres_nino')) echo set_value('nombres_nino'); else {if($ingreso) echo $ingreso['nombres_nino'];}?>" id="Nombres" placeholder="seccion">
      <?php echo form_error('nombres_nino');?>
      </br>
