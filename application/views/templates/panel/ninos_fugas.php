...
<h3><center>RESULTADOS DE NIÑOS FUGADOS</center></h3>
<br>
	...
	<thead>
		<tr>
            ...
            <th>Genéro</th>
            <th>Fecha ingreso</th>
            <th>Centro donde se encuentra</th>
            <th>Motivos ingreso</th>
            <th>Fecha fuga</th>
            <th>Centro de Fuga</th>
            <th>Motivos fuga</th>
            <th>¿Localizado?</th>
            <th>Estancia del niño</th>
		</tr>
	</thead>
	<tbody>
	<?php
	...
	?>
		<tr>
			...
			<td></td>
                ...
                <td><?php echo $g->fecha_fuga;?></td>
                <td><?php echo $g->nombre_centro;?></td>
                <td><?php echo $g->motivos_fuga;?></td> 
                <td><?php echo $g->localizado;?></td> 
                <td><?php echo $g->estancia_nino;?></td>  
