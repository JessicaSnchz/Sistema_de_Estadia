...
<br>
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              foreach ($expedientes_nutriologia as $e){
              ?>
              <tr>
            <td ><?php echo $e->no_expediente;?></td>
              ...
              <td><?php echo $e->nombre_centro;?></td>
                ...
                <td><a href="<?php echo base_url('index.php/proyecto/valoracion_nutriologica');?>/<?php echo $e->id_expediente;?>" role="button"><span class="glyphicon glyphicon-eye-open"></span></span></a></td>
              </tr>
              <?php 
              }
              ?>
